...
app.controller("LeaveBalanceSummaryController", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
    ...
    $scope.GetLeaveSummary = function (beData) {    
        ...
        var para = {
            BranchIdColl: $scope.filterLeaveSummary.BranchId ? $scope.filterLeaveSummary.BranchId.toString() : '',
            DepartmentIdColl: $scope.filterLeaveSummary.DepartmentId ? $scope.filterLeaveSummary.DepartmentId.toString() : '',
            CategoryIdColl: $scope.filterLeaveSummary.CategoryId ? $scope.filterLeaveSummary.CategoryId.toString() : '',
        ...
        $http({
            method: "post",
            url: base_url + "Attendance/Report/GetLeaveBalanaceSummary",
