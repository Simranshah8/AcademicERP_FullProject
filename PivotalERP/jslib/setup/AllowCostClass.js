...
app.controller('AllowCostClassController', function ($scope, $http, $timeout, $filter, GlobalServices) {
	...
	$scope.LoadData = function () {
		...
		$http({
			method: 'POST',
			url: base_url + "Setups/Security/GetUserListForSecurity",
			dataType: "json"
		}).then(function (res) {
	...
	$scope.CheckAllForTransaction = function () {
		var tmpData = $filter('filter')(
			$scope.AllowCostClassList,
			$scope.searchData.AllowCostClass
		);
	...
	$scope.CheckAllForEntry = function () {
		var tmpData = $filter('filter')(
			$scope.AllowCostClassList,
			$scope.searchData.AllowCostClass
		);
	...
	$scope.GetAllowCostClassList = function () {
		...
		$http({
			method: 'POST',
			url: base_url + "Setups/Security/GetAllowCostClass",
			dataType: "json",
	...
	$scope.CallSaveUpdateAllowCostClass = function () {
		...
		$http({
			method: 'POST',
			url: base_url + "Setups/Security/SaveAllowCostClass",
