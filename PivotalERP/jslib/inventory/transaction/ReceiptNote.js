...
app.controller('ReceiptNoteController', function ($scope, $http, $timeout, $filter, GlobalServices) {
    ...
    $scope.ProductSelectionChange = function (itemDet, ind) {
        ...
        if (itemDet.ProductId == null) {
           ...
           // itemDet.Rate = itemDet.productDetail.PurchaseRate;
            ...
            if (itemDet.OrderItemAllocationId > 0 ) {
                refStockItem = true;
            }

            if (isModify == false && refStockItem == false && (itemDet.IsImport == false || !itemDet.IsImport)) {
                itemDet.Rate = itemDet.productDetail.PurchaseRate;
    ...
    $scope.LoadRefProduct = function () {
        ...
        if (filterData.length > 0) {
            ...
            $timeout(function () {
                ...
                $http({
                    method: 'POST',
                    url: base_url + "Inventory/Transaction/GetPurchaseOrderDetailsByItemAllocationId",
                    dataType: "json",
