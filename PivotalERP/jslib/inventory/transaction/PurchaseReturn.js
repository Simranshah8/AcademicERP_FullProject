app.controller('PurchaseReturnController', function ($scope, $http, $timeout, $filter, GlobalServices) {
                    ...
                    if (idet.costLedgerDetail) {
                        if (idet.costLedgerDetail.AditionCostOnBasisOf == 0) {
                            ...
                            else if (idet.costLedgerDetail.LedgerType == 1) // Vat
                            {
                                ...
                                if (idet.costLedgerDetail.AditionCostOnBasisOf == 1) {
                                    amt1 = productAmt * idet.Rate / 100;
                                    idet.AccessableValue = productAmt;
                                }
                                else if (idet.costLedgerDetail.AditionCostOnBasisOf == 2) {
