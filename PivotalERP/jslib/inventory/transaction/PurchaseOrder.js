app.controller('PurchaseOrderController', function ($scope, $http, $timeout, $filter, GlobalServices) {
    ...
    $scope.ProductSelectionChange = function (itemDet, ind) {
        ...
        if (itemDet.ProductId == null) {
            ...
            if (isModify == false && (itemDet.IsImport == false || !itemDet.IsImport)) {
                itemDet.Rate = itemDet.productDetail.PurchaseRate;
    ...
    $scope.LoadRefProduct = function () {
        ...
        if (filterData.length > 0) {
            ...
            $timeout(function () {
                ...
                $http({
                    method: 'POST',
                    url: base_url + "Inventory/Transaction/GetPurchaseQuotationDetailsByItemAllocationId",
                    dataType: "json",
