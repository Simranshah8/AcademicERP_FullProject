...
namespace AcademicLib.BL.Attendance
{
	...
	public class LeaveQuotaByEmp
	{
		...
		public BE.Attendance.LeaveQuotaByEmpCollections getAllEmpLeaveQuota(int? BranchId, int? DepartmentId, int? CategoryId, int PeriodId)
		{
			return db.getAllEmpLeaveQuota(_UserId, BranchId, DepartmentId, CategoryId, PeriodId);
		}
		public ResponeValues SaveUpdate(AcademicLib.BE.Attendance.LeaveQuotaByEmpCollections dataColl)
		{
			ResponeValues resVal = new ResponeValues();
