...
namespace AcademicLib.DA.AppCMS.Creation
{
    internal class AcademicProgramDB
    {
        ...
        public ResponeValues SaveUpdate(AcademicLib.BE.AppCMS.Creation.AcademicProgram beData, bool isModify)
        {
        ...
        public AcademicLib.BE.AppCMS.Creation.AcademicProgramCollections getAllAcademicProgram(int UserId, int EntityId, string BranchCode)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    AcademicLib.BE.AppCMS.Creation.AcademicProgram beData = new AcademicLib.BE.AppCMS.Creation.AcademicProgram();
                    ...
                    if (!(reader[6] is DBNull)) beData.SubmenuTitle = reader.GetString(6);
        ...
        public AcademicLib.BE.AppCMS.Creation.AcademicProgram getAcademicProgramById(int UserId, int EntityId, int TranId)
        {
            AcademicLib.BE.AppCMS.Creation.AcademicProgram beData = new AcademicLib.BE.AppCMS.Creation.AcademicProgram();
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    beData = new AcademicLib.BE.AppCMS.Creation.AcademicProgram();
                    beData.TranId = reader.GetInt32(0);
                    if (!(reader[1] is DBNull)) beData.Title = reader.GetString(1);
                    if (!(reader[2] is DBNull)) beData.OrderNo = reader.GetInt32(2);
                    if (!(reader[3] is DBNull)) beData.Description = reader.GetString(3);
