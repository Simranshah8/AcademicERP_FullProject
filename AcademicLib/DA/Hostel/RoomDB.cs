   ...
   internal class RoomDB
    {
        ...
        public ResponeValues UpdateRoom(int UserId, int EntityId, int RoomId, double RoomFee)
        {
            ResponeValues resVal = new ResponeValues();
            ...
            cmd.Parameters.AddWithValue("@EntityId", EntityId);
            cmd.Parameters.AddWithValue("@RoomId", RoomId);
            cmd.CommandText = "usp_UpdateRoomRow";
            cmd.Parameters.Add("@ResponseMSG", System.Data.SqlDbType.NVarChar, 254);
            cmd.Parameters.Add("@IsSuccess", System.Data.SqlDbType.Bit);
            cmd.Parameters.Add("@ErrorNumber", System.Data.SqlDbType.Int);
            cmd.Parameters[3].Direction = System.Data.ParameterDirection.Output;
            cmd.Parameters[4].Direction = System.Data.ParameterDirection.Output;
            cmd.Parameters[5].Direction = System.Data.ParameterDirection.Output;
            cmd.Parameters.AddWithValue("@RoomFee", RoomFee);
            try
            {
                cmd.ExecuteNonQuery();
        ...
        public ResponeValues CurHostelRoomFee(int UserId, int EntityId, int AcademicYearId)
        {
            ResponeValues resVal = new ResponeValues();
            ...
            cmd.CommandText = "usp_UpdateCurRoomFee";
            cmd.Parameters.Add("@ResponseMSG", System.Data.SqlDbType.NVarChar, 254);
            cmd.Parameters.Add("@IsSuccess", System.Data.SqlDbType.Bit);
            cmd.Parameters.Add("@ErrorNumber", System.Data.SqlDbType.Int);
            cmd.Parameters[3].Direction = System.Data.ParameterDirection.Output;
