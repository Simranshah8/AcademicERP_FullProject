...
namespace AcademicLib.DA.Attendance
{
	...
	internal class LeaveQuotaByEmpDB
	{
		...
		public AcademicLib.BE.Attendance.LeaveQuotaByEmpCollections getAllLeaveQuotaByEmp(int UserId)
		{
			...
			try
			{
				...
				while (reader.Read())
				{
					AcademicLib.BE.Attendance.LeaveQuotaByEmp beData = new BE.Attendance.LeaveQuotaByEmp();
		...
		public AcademicLib.BE.Attendance.LeaveQuotaByEmp getLeaveQuotaByEmpById(int UserId, int UsersId, int PeriodId)
		{
			AcademicLib.BE.Attendance.LeaveQuotaByEmp beData = new BE.Attendance.LeaveQuotaByEmp();
			...
			try
			{
				...
				while (reader.Read())
				{
					AcademicLib.BE.Attendance.LeaveQuotaByEmpDetails det = new BE.Attendance.LeaveQuotaByEmpDetails();
		...
		public AcademicLib.BE.Attendance.LeaveQuotaByEmpCollections getAllEmpLeaveQuota(int UserId, int? BranchId, int? DepartmentId, int? CategoryId, int PeriodId)
		{
			AcademicLib.BE.Attendance.LeaveQuotaByEmpCollections dataColl = new AcademicLib.BE.Attendance.LeaveQuotaByEmpCollections();
			dal.OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = dal.GetCommand();
			...
			try
			{
				...
				while (reader.Read())
				{
					AcademicLib.BE.Attendance.LeaveQuotaByEmp beData = new AcademicLib.BE.Attendance.LeaveQuotaByEmp();
					...
					if (!(reader[17] is DBNull)) beData.IsAllow = Convert.ToBoolean(reader[17]);
					dataColl.Add(beData);
				}
				reader.Close();
				dataColl.IsSuccess = true;
		...
		public ResponeValues SaveUpdateLeaveQuotaColl(int UserId, AcademicLib.BE.Attendance.LeaveQuotaByEmpCollections dataColl)
		{
			ResponeValues resVal = new ResponeValues();
			dal.OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = dal.GetCommand();
