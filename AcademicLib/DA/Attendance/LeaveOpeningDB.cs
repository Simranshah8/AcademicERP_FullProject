...
namespace AcademicLib.DA.Attendance
{
    internal class LeaveOpeningDB
    {
        ...
        //EmployeeWise LEave Opening Starts from here
        public AcademicLib.BE.Attendance.LeaveOpeningCollections getAllEmpLeaveOpening(int UserId, int? BranchId, int? DepartmentId, int? CategoryId, int PeriodId)
        {
            AcademicLib.BE.Attendance.LeaveOpeningCollections dataColl = new AcademicLib.BE.Attendance.LeaveOpeningCollections();
            dal.OpenConnection();
            System.Data.SqlClient.SqlCommand cmd = dal.GetCommand();
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    AcademicLib.BE.Attendance.LeaveOpening beData = new AcademicLib.BE.Attendance.LeaveOpening();
        ...
        public ResponeValues SaveUpdateLeaveOpeningColl(int UserId, AcademicLib.BE.Attendance.LeaveOpeningCollections dataColl)
        {
            ResponeValues resVal = new ResponeValues();
            dal.OpenConnection();
            System.Data.SqlClient.SqlCommand cmd = dal.GetCommand();
        ...
        public ResponeValues DeleteEmpById(int UserId, int? TranId, int? PeriodId)
        {
            ResponeValues resVal = new ResponeValues();
