...
namespace AcademicLib.DA.Attendance
{
    internal class AllowLeaveTypeDB
    {
        ...
        public ResponeValues UpdateAllowLeaveType(int UserId, List<AcademicLib.BE.Attendance.AllowLeaveType> DataColl)
        {
        ...
        public AcademicLib.BE.Attendance.EmployeeForAllowLeaveTypeCollections getAllAllowLeaveType(int UserId, int EntityId, int? BranchId, int? DepartmentId, int? DesignationId, int? LevelId, int? EmployeeGroupId)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    AcademicLib.BE.Attendance.EmployeeForAllowLeaveType beData = new AcademicLib.BE.Attendance.EmployeeForAllowLeaveType();
        ...
        public AcademicLib.BE.Attendance.EmployeeForAllowLeaveTypeCollections GetLeaveTypeByEmployee(int UserId, int UsersId)
        {
            AcademicLib.BE.Attendance.EmployeeForAllowLeaveTypeCollections dataColl = new AcademicLib.BE.Attendance.EmployeeForAllowLeaveTypeCollections();
        ...
        public ResponeValues DeleteById(int UserId, int EntityId)
        {
            ResponeValues resVal = new ResponeValues();
            ...
            cmd.Parameters.AddWithValue("@UserId", UserId);
            cmd.Parameters.AddWithValue("@EntityId", EntityId);
            cmd.CommandText = "usp_DelAllowLeaveType";
            cmd.Parameters.Add("@ResponseMSG", System.Data.SqlDbType.NVarChar, 254);
