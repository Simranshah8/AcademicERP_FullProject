        ...
        public BE.Attendance.WorkingShiftCollections getAllWorkingShift(int UserId)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    if (!(reader[6] is System.DBNull)) beData.IsDefault = reader.GetBoolean(6);
        ...
        public BE.Attendance.WorkingShift getWorkingShiftById(int WorkingShiftId, int UserId)
        {
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    if (!(reader[30] is System.DBNull)) beData.UserName = reader.GetString(30);
                    if (!(reader[31] is System.DBNull)) beData.AbsentNoticeTime = reader.GetDateTime(31);
                    if (!(reader[32] is System.DBNull)) beData.IsDefault = reader.GetBoolean(32);
