...
namespace AcademicLib.DA.Attendance
{
    ...
    internal class LeaveBalanceSummaryDB
    {
        ...
        public BE.Attendance.LeaveBalanceSummaryCollections GetLeaveBalanaceSummary(int UserId, string BranchIdColl = "", string DepartmentIdColl = "", string CategoryIdColl = "", int? ForUserId = null, int? PeriodId = null,int? LeaveTypeId = null )
        {
