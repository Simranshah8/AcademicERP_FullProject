...
namespace AcademicLib.DA.Fee.Creation
{
    internal class ManualBillingClassWiseDB
    {
        ...
        public ResponeValues SaveManualBillingClassWise(int AcademicYearId, BE.Fee.Creation.ManualBilling beData, bool isModify)
        {
            ResponeValues resVal = new ResponeValues();
            ...
            if (isModify)
            {
                cmd.CommandText = "usp_UpdateClassWiseManualBilling";
            }
            else
            {
                cmd.Parameters[6].Direction = System.Data.ParameterDirection.Output;
                cmd.CommandText = "usp_AddClassWiseManualBilling";
            }
            cmd.Parameters.Add("@ResponseMSG", System.Data.SqlDbType.NVarChar, 254);
            cmd.Parameters.Add("@IsSuccess", System.Data.SqlDbType.Bit);
            cmd.Parameters.Add("@ErrorNumber", System.Data.SqlDbType.Int);
        ...
        private void SaveManualBillingDetailss(int UserId, int TranId, List<BE.Fee.Creation.ManualBillingDetails> beDataColl)
        {
            ...
            foreach (BE.Fee.Creation.ManualBillingDetails beData in beDataColl)
            {
                ...
                cmd.Parameters.AddWithValue("@Remarks", beData.Remarks);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.CommandText = "usp_AddManualBillingClassWiseDetails";
                cmd.ExecuteNonQuery();
            }
        }
        ...
        public AcademicLib.BE.Fee.Creation.ManualBillingCollections GetAllClassWiseManualBilling(int UserId, int AcademicYearId, int EntityId)
        {
            AcademicLib.BE.Fee.Creation.ManualBillingCollections dataColl = new AcademicLib.BE.Fee.Creation.ManualBillingCollections();
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    if (!(reader[1] is DBNull)) beData.AutoNumber = reader.GetInt32(1);
                    if (!(reader[2] is DBNull)) beData.BillingDate = reader.GetDateTime(2);
                    if (!(reader[3] is DBNull)) beData.BillingDataBS = reader.GetString(3);
                    ...
                    if (!(reader[8] is DBNull)) beData.TotalAmount = Convert.ToDouble(reader[8]);
                    if (!(reader[9] is DBNull)) beData.Remarks = reader.GetString(9);
                    if (!(reader[10] is DBNull)) beData.ForMonthId = reader.GetInt32(10);
                    if (!(reader[11] is DBNull)) beData.ForMonthName = reader.GetString(11);
                    if (!(reader[12] is DBNull)) beData.BillingType = (AcademicLib.BE.Fee.Creation.BILLINGTYPES)reader.GetInt32(12);
                    dataColl.Add(beData);
                }
        ...
        public AcademicLib.BE.Fee.Creation.ManualBilling getClassWiseManualBillingDetailsById(int UserId, int TranId)
        {
            AcademicLib.BE.Fee.Creation.ManualBilling beData = new AcademicLib.BE.Fee.Creation.ManualBilling();
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    if (!(reader[8] is DBNull)) beData.TotalAmount = Convert.ToDouble(reader[8]);
                    if (!(reader[9] is DBNull)) beData.Remarks = reader.GetString(9);
                    if (!(reader[10] is DBNull)) beData.ForMonthName = reader.GetString(10);
                    if (!(reader[11] is DBNull)) beData.BillingType = (AcademicLib.BE.Fee.Creation.BILLINGTYPES)reader.GetInt32(11);
                }
                beData.ManualBillingDetailsColl = new BE.Fee.Creation.ManualBillingDetailsCollections();
                reader.NextResult();
                while (reader.Read())
