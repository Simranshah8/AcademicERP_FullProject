...
namespace AcademicLib.DA.Exam.Creation
{
    ...
    internal class AssessmentTypeDB
    {
        DataAccessLayer1 dal = null;
        public AssessmentTypeDB(string hostName, string dbName)
        {
            dal = new DataAccessLayer1(hostName, dbName);
        }
        public ResponeValues SaveUpdate(BE.Exam.Creation.AssessmentType beData, bool isModify)
        {
            ...
            if (isModify)
            {
                cmd.CommandText = "usp_UpdateAssessmentType";
            }
            else
            {
                cmd.Parameters[6].Direction = System.Data.ParameterDirection.Output;
                cmd.CommandText = "usp_AddAssessmentType";
            }
        ...
        public ResponeValues DeleteById(int UserId, int EntityId, int AssessmentTypeId)
        {
            ResponeValues resVal = new ResponeValues();
            dal.OpenConnection();
            System.Data.SqlClient.SqlCommand cmd = dal.GetCommand();
            ...
            cmd.CommandText = "usp_DelAssessmentTypeById";
            cmd.Parameters.Add("@ResponseMSG", System.Data.SqlDbType.NVarChar, 254);
            cmd.Parameters.Add("@IsSuccess", System.Data.SqlDbType.Bit);
            cmd.Parameters.Add("@ErrorNumber", System.Data.SqlDbType.Int);
        ...
        public BE.Exam.Creation.AssessmentTypeColl getAllAssessmentType(int UserId, int EntityId)
        {
            BE.Exam.Creation.AssessmentTypeColl dataColl = new BE.Exam.Creation.AssessmentTypeColl();
            dal.OpenConnection();
            System.Data.SqlClient.SqlCommand cmd = dal.GetCommand();
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@UserId", UserId);
            cmd.Parameters.AddWithValue("@EntityId", EntityId);
            cmd.CommandText = "usp_GetAllAssessmentType";
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    if (!(reader[0] is DBNull)) beData.AssessmentTypeId = reader.GetInt32(0);
        ...
        public BE.Exam.Creation.AssessmentType getAssessmentTypeById(int UserId, int EntityId, int AssessmentTypeId)
        {
            ...
            cmd.Parameters.AddWithValue("@UserId", UserId);
            cmd.Parameters.AddWithValue("@EntityId", EntityId);
            cmd.CommandText = "usp_GetAssessmentTypeById";
            try
            {
                System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
                if (reader.Read())
                {
                    beData = new BE.Exam.Creation.AssessmentType();
                    if (!(reader[0] is DBNull)) beData.AssessmentTypeId = reader.GetInt32(0);
                    if (!(reader[1] is DBNull)) beData.BranchId = reader.GetInt32(1);
                    if (!(reader[2] is DBNull)) beData.Name = reader.GetString(2);
                    if (!(reader[3] is DBNull)) beData.Description = reader.GetString(3);
